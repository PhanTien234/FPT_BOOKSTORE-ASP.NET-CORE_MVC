...
var connectionString = builder.Configuration.GetConnectionString("ThanhConnection") ?? throw new InvalidOperationException("Connection string 'DefaultConnection' not found.");
